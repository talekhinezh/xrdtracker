...
/// struct for typed errors of method [`mempool_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MempoolPostError {
...
pub async fn mempool_post(configuration: &configuration::Configuration, mempool_request: crate::models::MempoolRequest) -> Result<crate::models::MempoolResponse, Error<MempoolPostError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&mempool_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MempoolPostError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn mempool_transaction_post(configuration: &configuration::Configuration, mempool_transaction_request: crate::models::MempoolTransactionRequest) -> Result<crate::models::MempoolTransactionResponse, Error<MempoolTransactionPostError>> {
    let local_var_configuration = configuration;
