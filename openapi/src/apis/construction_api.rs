...
/// struct for typed errors of method [`construction_build_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConstructionBuildPostError {
    Status500(crate::models::UnexpectedError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`construction_derive_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConstructionDerivePostError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`construction_finalize_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConstructionFinalizePostError {
    Status500(crate::models::UnexpectedError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`construction_hash_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConstructionHashPostError {
    Status500(crate::models::UnexpectedError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`construction_parse_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConstructionParsePostError {
    Status500(crate::models::UnexpectedError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`construction_submit_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConstructionSubmitPostError {
    Status500(crate::models::UnexpectedError),
    UnknownValue(serde_json::Value),
}


pub async fn construction_build_post(configuration: &configuration::Configuration, construction_build_request: crate::models::ConstructionBuildRequest) -> Result<crate::models::ConstructionBuildResponse, Error<ConstructionBuildPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/construction/build", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&construction_build_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConstructionBuildPostError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn construction_derive_post(configuration: &configuration::Configuration, construction_derive_request: crate::models::ConstructionDeriveRequest) -> Result<crate::models::ConstructionDeriveResponse, Error<ConstructionDerivePostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConstructionDerivePostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn construction_finalize_post(configuration: &configuration::Configuration, construction_finalize_request: crate::models::ConstructionFinalizeRequest) -> Result<crate::models::ConstructionFinalizeResponse, Error<ConstructionFinalizePostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/construction/finalize", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&construction_finalize_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConstructionFinalizePostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn construction_hash_post(configuration: &configuration::Configuration, construction_hash_request: crate::models::ConstructionHashRequest) -> Result<crate::models::ConstructionHashResponse, Error<ConstructionHashPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConstructionHashPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn construction_parse_post(configuration: &configuration::Configuration, construction_parse_request: crate::models::ConstructionParseRequest) -> Result<crate::models::ConstructionParseResponse, Error<ConstructionParsePostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConstructionParsePostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn construction_submit_post(configuration: &configuration::Configuration, construction_submit_request: crate::models::ConstructionSubmitRequest) -> Result<crate::models::ConstructionSubmitResponse, Error<ConstructionSubmitPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConstructionSubmitPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
