...
/// struct for typed errors of method [`network_configuration_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NetworkConfigurationPostError {
    Status500(crate::models::UnexpectedError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`network_status_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NetworkStatusPostError {
    Status500(crate::models::UnexpectedError),
    UnknownValue(serde_json::Value),
}
...
pub async fn network_configuration_post(configuration: &configuration::Configuration, body: serde_json::Value) -> Result<crate::models::NetworkConfigurationResponse, Error<NetworkConfigurationPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/network/configuration", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NetworkConfigurationPostError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn network_status_post(configuration: &configuration::Configuration, network_status_request: crate::models::NetworkStatusRequest) -> Result<crate::models::NetworkStatusResponse, Error<NetworkStatusPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NetworkStatusPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
