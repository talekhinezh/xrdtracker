...
/// struct for typed errors of method [`entity_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum EntityPostError {
...
pub async fn entity_post(configuration: &configuration::Configuration, entity_request: crate::models::EntityRequest) -> Result<crate::models::EntityResponse, Error<EntityPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/entity", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EntityPostError> = serde_json::from_str(&local_var_content).ok();
