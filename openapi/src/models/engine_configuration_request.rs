...
pub struct EngineConfigurationRequest {
    #[serde(rename = "network_identifier")]
    pub network_identifier: Box<crate::models::NetworkIdentifier>,
}

impl EngineConfigurationRequest {
    pub fn new(network_identifier: crate::models::NetworkIdentifier) -> EngineConfigurationRequest {
