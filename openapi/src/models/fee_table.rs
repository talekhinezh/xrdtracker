...
pub struct FeeTable {
    #[serde(rename = "per_up_substate_fee")]
    pub per_up_substate_fee: Vec<crate::models::UpSubstateFeeEntry>,
    #[serde(rename = "per_byte_fee")]
    pub per_byte_fee: Box<crate::models::ResourceAmount>,
}

impl FeeTable {
    pub fn new(per_up_substate_fee: Vec<crate::models::UpSubstateFeeEntry>, per_byte_fee: crate::models::ResourceAmount) -> FeeTable {
        FeeTable {
            per_up_substate_fee,
            per_byte_fee: Box::new(per_byte_fee),
        }
    }
}
