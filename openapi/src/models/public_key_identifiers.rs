...
pub struct PublicKeyIdentifiers {
    #[serde(rename = "account_entity_identifier")]
    pub account_entity_identifier: Box<crate::models::EntityIdentifier>,
    #[serde(rename = "validator_entity_identifier")]
    pub validator_entity_identifier: Box<crate::models::EntityIdentifier>,
    #[serde(rename = "p2p_node")]
    pub p2p_node: Box<crate::models::Peer>,
}

impl PublicKeyIdentifiers {
    pub fn new(account_entity_identifier: crate::models::EntityIdentifier, validator_entity_identifier: crate::models::EntityIdentifier, p2p_node: crate::models::Peer) -> PublicKeyIdentifiers {
        PublicKeyIdentifiers {
            account_entity_identifier: Box::new(account_entity_identifier),
            validator_entity_identifier: Box::new(validator_entity_identifier),
            p2p_node: Box::new(p2p_node),
        }
    }
}
