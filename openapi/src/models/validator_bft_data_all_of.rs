...
pub struct ValidatorBftDataAllOf {
    #[serde(rename = "proposals_completed")]
    pub proposals_completed: i64,
    #[serde(rename = "proposals_missed")]
    pub proposals_missed: i64,
}

impl ValidatorBftDataAllOf {
    pub fn new(proposals_completed: i64, proposals_missed: i64) -> ValidatorBftDataAllOf {
        ValidatorBftDataAllOf {
            proposals_completed,
            proposals_missed,
        }
    }
