...
pub struct PublicKeyNotSupportedError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl PublicKeyNotSupportedError {
    pub fn new(_type: String, unsupported_public_key: crate::models::PublicKey) -> PublicKeyNotSupportedError {
