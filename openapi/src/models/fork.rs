...
pub struct Fork {
    #[serde(rename = "fork_identifier")]
    pub fork_identifier: Box<crate::models::ForkIdentifier>,
    #[serde(rename = "engine_identifier")]
    pub engine_identifier: Box<crate::models::EngineIdentifier>,
    #[serde(rename = "engine_configuration")]
    pub engine_configuration: Box<crate::models::EngineConfiguration>,
}

impl Fork {
    pub fn new(fork_identifier: crate::models::ForkIdentifier, engine_identifier: crate::models::EngineIdentifier, engine_configuration: crate::models::EngineConfiguration) -> Fork {
        Fork {
            fork_identifier: Box::new(fork_identifier),
            engine_identifier: Box::new(engine_identifier),
            engine_configuration: Box::new(engine_configuration),
        }
    }
}
