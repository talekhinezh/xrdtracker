...
pub struct NotValidatorEntityErrorAllOf {
    #[serde(rename = "entity")]
    pub entity: Box<crate::models::EntityIdentifier>,
}

impl NotValidatorEntityErrorAllOf {
    pub fn new(entity: crate::models::EntityIdentifier) -> NotValidatorEntityErrorAllOf {
        NotValidatorEntityErrorAllOf {
