...
pub struct NotEnoughNativeTokensForFeesError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl NotEnoughNativeTokensForFeesError {
    pub fn new(_type: String, available: crate::models::ResourceAmount, fee_estimate: crate::models::ResourceAmount) -> NotEnoughNativeTokensForFeesError {
