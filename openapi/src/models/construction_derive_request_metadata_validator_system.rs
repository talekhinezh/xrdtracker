...
pub struct ConstructionDeriveRequestMetadataValidatorSystem {
    #[serde(rename = "type")]
    pub _type: String,
}

impl ConstructionDeriveRequestMetadataValidatorSystem {
    pub fn new(_type: String) -> ConstructionDeriveRequestMetadataValidatorSystem {
