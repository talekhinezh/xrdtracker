...
pub struct ConstructionDeriveRequestMetadataPreparedUnstakes {
    #[serde(rename = "type")]
    pub _type: String,
}

impl ConstructionDeriveRequestMetadataPreparedUnstakes {
    pub fn new(_type: String) -> ConstructionDeriveRequestMetadataPreparedUnstakes {
