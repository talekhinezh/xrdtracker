...
pub struct EntityResponse {
    ...
    pub balances: Vec<crate::models::ResourceAmount>,
    /// Data associated with the entity.
    #[serde(rename = "data_objects")]
    pub data_objects: Vec<crate::models::DataObject>,
}

impl EntityResponse {
    pub fn new(state_identifier: crate::models::StateIdentifier, balances: Vec<crate::models::ResourceAmount>, data_objects: Vec<crate::models::DataObject>) -> EntityResponse {
        EntityResponse {
