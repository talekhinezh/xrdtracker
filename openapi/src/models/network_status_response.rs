...
pub struct NetworkStatusResponse {
    ...
    pub pre_genesis_state_identifier: Box<crate::models::StateIdentifier>,
    #[serde(rename = "genesis_state_identifier")]
    pub genesis_state_identifier: Box<crate::models::StateIdentifier>,
    #[serde(rename = "current_state_identifier")]
    pub current_state_identifier: Box<crate::models::StateIdentifier>,
    #[serde(rename = "sync_status")]
    pub sync_status: Box<crate::models::SyncStatus>,
...
impl NetworkStatusResponse {
    pub fn new(pre_genesis_state_identifier: crate::models::StateIdentifier, genesis_state_identifier: crate::models::StateIdentifier, current_state_identifier: crate::models::StateIdentifier, sync_status: crate::models::SyncStatus, peers: Vec<crate::models::Peer>) -> NetworkStatusResponse {
        NetworkStatusResponse {
            pre_genesis_state_identifier: Box::new(pre_genesis_state_identifier),
            genesis_state_identifier: Box::new(genesis_state_identifier),
