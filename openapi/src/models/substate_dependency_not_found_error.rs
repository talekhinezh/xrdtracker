...
pub struct SubstateDependencyNotFoundError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl SubstateDependencyNotFoundError {
    pub fn new(_type: String, substate_identifier_not_found: crate::models::SubstateIdentifier) -> SubstateDependencyNotFoundError {
