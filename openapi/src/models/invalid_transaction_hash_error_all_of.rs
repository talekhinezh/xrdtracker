...
pub struct InvalidTransactionHashErrorAllOf {
    #[serde(rename = "invalid_transaction_hash")]
    pub invalid_transaction_hash: String,
}

impl InvalidTransactionHashErrorAllOf {
    pub fn new(invalid_transaction_hash: String) -> InvalidTransactionHashErrorAllOf {
