...
pub struct ConstructionDeriveRequestMetadataExitingUnstakes {
    #[serde(rename = "type")]
    pub _type: String,
...
impl ConstructionDeriveRequestMetadataExitingUnstakes {
    pub fn new(_type: String, validator: crate::models::EntityIdentifier, epoch_unlock: i64) -> ConstructionDeriveRequestMetadataExitingUnstakes {
