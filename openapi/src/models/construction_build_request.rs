...
pub struct ConstructionBuildRequest {
    ...
    pub fee_payer: Box<crate::models::EntityIdentifier>,
    ...
    #[serde(rename = "disable_resource_allocate_and_destroy", skip_serializing_if = "Option::is_none")]
    pub disable_resource_allocate_and_destroy: Option<bool>,
}

impl ConstructionBuildRequest {
    pub fn new(network_identifier: crate::models::NetworkIdentifier, operation_groups: Vec<crate::models::OperationGroup>, fee_payer: crate::models::EntityIdentifier) -> ConstructionBuildRequest {
        ConstructionBuildRequest {
            network_identifier: Box::new(network_identifier),
            operation_groups,
            fee_payer: Box::new(fee_payer),
            message: None,
            disable_resource_allocate_and_destroy: None,
        }
    }
}
