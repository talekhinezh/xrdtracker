...
pub struct InvalidAddressErrorAllOf {
    #[serde(rename = "invalid_address")]
    pub invalid_address: String,
}

impl InvalidAddressErrorAllOf {
    pub fn new(invalid_address: String) -> InvalidAddressErrorAllOf {
        InvalidAddressErrorAllOf {
            invalid_address,
        }
    }
}
