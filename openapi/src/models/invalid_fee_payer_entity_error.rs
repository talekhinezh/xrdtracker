...
pub struct InvalidFeePayerEntityError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl InvalidFeePayerEntityError {
    pub fn new(_type: String, invalid_fee_payer_entity: crate::models::EntityIdentifier) -> InvalidFeePayerEntityError {
