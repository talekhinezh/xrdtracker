...
pub struct NotEnoughNativeTokensForFeesErrorAllOf {
    #[serde(rename = "available")]
    pub available: Box<crate::models::ResourceAmount>,
    #[serde(rename = "fee_estimate")]
    pub fee_estimate: Box<crate::models::ResourceAmount>,
}

impl NotEnoughNativeTokensForFeesErrorAllOf {
    pub fn new(available: crate::models::ResourceAmount, fee_estimate: crate::models::ResourceAmount) -> NotEnoughNativeTokensForFeesErrorAllOf {
