...
pub struct InvalidPartialStateIdentifierErrorAllOf {
    #[serde(rename = "invalid_partial_state_identifier")]
    pub invalid_partial_state_identifier: Box<crate::models::PartialStateIdentifier>,
}

impl InvalidPartialStateIdentifierErrorAllOf {
    pub fn new(invalid_partial_state_identifier: crate::models::PartialStateIdentifier) -> InvalidPartialStateIdentifierErrorAllOf {
        InvalidPartialStateIdentifierErrorAllOf {
            invalid_partial_state_identifier: Box::new(invalid_partial_state_identifier),
        }
    }
}
