...
pub struct DataObjectNotSupportedByEntityErrorAllOf {
    ...
    pub data_object_not_supported: Box<crate::models::DataObject>,
}

impl DataObjectNotSupportedByEntityErrorAllOf {
    pub fn new(entity_identifier: crate::models::EntityIdentifier, data_object_not_supported: crate::models::DataObject) -> DataObjectNotSupportedByEntityErrorAllOf {
        DataObjectNotSupportedByEntityErrorAllOf {
            entity_identifier: Box::new(entity_identifier),
            data_object_not_supported: Box::new(data_object_not_supported),
        }
    }
}
