...
pub struct ResourceDepositOperationNotSupportedByEntityError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl ResourceDepositOperationNotSupportedByEntityError {
    pub fn new(_type: String, entity_identifier: crate::models::EntityIdentifier, resource_deposit_not_supported: crate::models::ResourceIdentifier) -> ResourceDepositOperationNotSupportedByEntityError {
