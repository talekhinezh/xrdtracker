...
pub struct StateIdentifierNotFoundError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl StateIdentifierNotFoundError {
    pub fn new(_type: String, state_identifier: crate::models::PartialStateIdentifier) -> StateIdentifierNotFoundError {
