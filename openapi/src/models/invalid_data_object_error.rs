...
pub struct InvalidDataObjectError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl InvalidDataObjectError {
    pub fn new(_type: String, invalid_data_object: crate::models::DataObject, message: String) -> InvalidDataObjectError {
