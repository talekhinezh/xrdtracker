...
pub struct InvalidDataObjectErrorAllOf {
    #[serde(rename = "invalid_data_object")]
    pub invalid_data_object: Box<crate::models::DataObject>,
    #[serde(rename = "message")]
    pub message: String,
}

impl InvalidDataObjectErrorAllOf {
    pub fn new(invalid_data_object: crate::models::DataObject, message: String) -> InvalidDataObjectErrorAllOf {
        InvalidDataObjectErrorAllOf {
            invalid_data_object: Box::new(invalid_data_object),
            message,
        }
    }
}
