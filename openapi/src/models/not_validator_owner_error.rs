...
pub struct NotValidatorOwnerError {
    #[serde(rename = "type")]
    pub _type: String,
    #[serde(rename = "owner")]
...
impl NotValidatorOwnerError {
    pub fn new(_type: String, owner: crate::models::EntityIdentifier, user: crate::models::EntityIdentifier) -> NotValidatorOwnerError {
