...
pub struct InvalidTransactionHashError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl InvalidTransactionHashError {
    pub fn new(_type: String, invalid_transaction_hash: String) -> InvalidTransactionHashError {
