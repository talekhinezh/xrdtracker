...
pub struct Signature {
    ...
    /// An ECDSA signature of with the given `public_key`. The ECDSA signature should be created using the secp256k1 curve and should be encoded in DER format, and then encoded as a hex string.
    #[serde(rename = "bytes")]
    pub bytes: String,
}

impl Signature {
    pub fn new(public_key: crate::models::PublicKey, bytes: String) -> Signature {
        Signature {
