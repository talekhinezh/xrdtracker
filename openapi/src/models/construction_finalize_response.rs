...
pub struct ConstructionFinalizeResponse {
    /// Hex encoded signed transaction which can be submitted.
    #[serde(rename = "signed_transaction")]
    pub signed_transaction: String,
}

impl ConstructionFinalizeResponse {
    pub fn new(signed_transaction: String) -> ConstructionFinalizeResponse {
