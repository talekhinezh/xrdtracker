...
pub struct ConstructionDeriveRequestMetadataPreparedStakes {
    #[serde(rename = "type")]
    pub _type: String,
...
impl ConstructionDeriveRequestMetadataPreparedStakes {
    pub fn new(_type: String, validator: crate::models::EntityIdentifier) -> ConstructionDeriveRequestMetadataPreparedStakes {
