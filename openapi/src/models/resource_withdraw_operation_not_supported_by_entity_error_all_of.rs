...
pub struct ResourceWithdrawOperationNotSupportedByEntityErrorAllOf {
    #[serde(rename = "entity_identifier")]
    pub entity_identifier: Box<crate::models::EntityIdentifier>,
    #[serde(rename = "resource_withdraw_not_supported")]
    pub resource_withdraw_not_supported: Box<crate::models::ResourceIdentifier>,
}

impl ResourceWithdrawOperationNotSupportedByEntityErrorAllOf {
    pub fn new(entity_identifier: crate::models::EntityIdentifier, resource_withdraw_not_supported: crate::models::ResourceIdentifier) -> ResourceWithdrawOperationNotSupportedByEntityErrorAllOf {
        ResourceWithdrawOperationNotSupportedByEntityErrorAllOf {
            entity_identifier: Box::new(entity_identifier),
            resource_withdraw_not_supported: Box::new(resource_withdraw_not_supported),
        }
    }
}
