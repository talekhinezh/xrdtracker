...
pub struct TransactionNotFoundErrorAllOf {
    #[serde(rename = "transaction_identifier")]
    pub transaction_identifier: Box<crate::models::TransactionIdentifier>,
}

impl TransactionNotFoundErrorAllOf {
    pub fn new(transaction_identifier: crate::models::TransactionIdentifier) -> TransactionNotFoundErrorAllOf {
