...
pub struct ResourceAmount {
    #[serde(rename = "value")]
    pub value: String,
    #[serde(rename = "resource_identifier")]
    pub resource_identifier: Box<crate::models::ResourceIdentifier>,
}

impl ResourceAmount {
    pub fn new(value: String, resource_identifier: crate::models::ResourceIdentifier) -> ResourceAmount {
        ResourceAmount {
            value,
            resource_identifier: Box::new(resource_identifier),
        }
    }
}
