...
pub struct EngineConfigurationResponse {
    #[serde(rename = "checkpoints")]
    pub checkpoints: Vec<crate::models::EngineCheckpoint>,
    #[serde(rename = "forks")]
    pub forks: Vec<crate::models::Fork>,
}

impl EngineConfigurationResponse {
    pub fn new(checkpoints: Vec<crate::models::EngineCheckpoint>, forks: Vec<crate::models::Fork>) -> EngineConfigurationResponse {
