...
pub struct ConstructionDeriveRequestMetadataToken {
    #[serde(rename = "type")]
    pub _type: String,
...
impl ConstructionDeriveRequestMetadataToken {
    pub fn new(_type: String, symbol: String) -> ConstructionDeriveRequestMetadataToken {
