...
pub struct NetworkNotSupportedError {
    ...
    pub supported_networks: Vec<crate::models::NetworkIdentifier>,
}

impl NetworkNotSupportedError {
    pub fn new(_type: String, supported_networks: Vec<crate::models::NetworkIdentifier>) -> NetworkNotSupportedError {
