...
pub struct EngineStatusResponse {
    ...
    pub validator_set: Vec<crate::models::Validator>,
}

impl EngineStatusResponse {
    pub fn new(engine_state_identifier: crate::models::EngineStateIdentifier, validator_set: Vec<crate::models::Validator>) -> EngineStatusResponse {
