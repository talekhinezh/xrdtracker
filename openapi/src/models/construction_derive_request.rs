...
pub struct ConstructionDeriveRequest {
    ...
    pub metadata: Box<crate::models::ConstructionDeriveRequestMetadata>,
}

impl ConstructionDeriveRequest {
    pub fn new(network_identifier: crate::models::NetworkIdentifier, public_key: crate::models::PublicKey, metadata: crate::models::ConstructionDeriveRequestMetadata) -> ConstructionDeriveRequest {
