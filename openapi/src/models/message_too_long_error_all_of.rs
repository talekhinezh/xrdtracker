...
pub struct MessageTooLongErrorAllOf {
    #[serde(rename = "maximum_message_length")]
    pub maximum_message_length: i32,
    #[serde(rename = "attempted_message_length")]
    pub attempted_message_length: i32,
}

impl MessageTooLongErrorAllOf {
    pub fn new(maximum_message_length: i32, attempted_message_length: i32) -> MessageTooLongErrorAllOf {
