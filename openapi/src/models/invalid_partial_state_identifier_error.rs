...
pub struct InvalidPartialStateIdentifierError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl InvalidPartialStateIdentifierError {
    pub fn new(_type: String, invalid_partial_state_identifier: crate::models::PartialStateIdentifier) -> InvalidPartialStateIdentifierError {
