...
pub struct ConstructionDeriveRequestMetadataValidator {
    #[serde(rename = "type")]
    pub _type: String,
}

impl ConstructionDeriveRequestMetadataValidator {
    pub fn new(_type: String) -> ConstructionDeriveRequestMetadataValidator {
