...
pub struct EngineStateIdentifier {
...
impl EngineStateIdentifier {
    pub fn new(state_identifier: crate::models::StateIdentifier, epoch: i64, round: i64, timestamp: i64) -> EngineStateIdentifier {
