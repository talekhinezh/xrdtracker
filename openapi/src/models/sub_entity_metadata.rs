...
pub struct SubEntityMetadata {
    #[serde(rename = "validator_address", skip_serializing_if = "Option::is_none")]
    pub validator_address: Option<String>,
    #[serde(rename = "epoch_unlock", skip_serializing_if = "Option::is_none")]
    pub epoch_unlock: Option<i64>,
}

impl SubEntityMetadata {
    pub fn new() -> SubEntityMetadata {
        SubEntityMetadata {
