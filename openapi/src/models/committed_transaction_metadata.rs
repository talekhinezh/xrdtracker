...
pub struct CommittedTransactionMetadata {
    ...
    pub fee: Option<Box<crate::models::ResourceAmount>>,
    #[serde(rename = "signed_by", skip_serializing_if = "Option::is_none")]
    pub signed_by: Option<Box<crate::models::PublicKey>>,
    /// Optional hex encoded byte array in the transaction.
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
}

impl CommittedTransactionMetadata {
    pub fn new(size: i32, hex: String) -> CommittedTransactionMetadata {
