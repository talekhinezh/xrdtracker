...
pub struct EngineCheckpoint {
    #[serde(rename = "engine_state_identifier")]
    pub engine_state_identifier: Box<crate::models::EngineStateIdentifier>,
    #[serde(rename = "checkpoint_transaction", skip_serializing_if = "Option::is_none")]
    pub checkpoint_transaction: Option<String>,
}

impl EngineCheckpoint {
    pub fn new(engine_state_identifier: crate::models::EngineStateIdentifier) -> EngineCheckpoint {
        EngineCheckpoint {
            engine_state_identifier: Box::new(engine_state_identifier),
