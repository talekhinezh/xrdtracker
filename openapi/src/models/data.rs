...
pub struct Data {
    ...
    #[serde(rename = "action")]
    pub action: Action,
    #[serde(rename = "data_object")]
    pub data_object: Box<crate::models::DataObject>,
}

impl Data {
    pub fn new(action: Action, data_object: crate::models::DataObject) -> Data {
        Data {
            action,
            data_object: Box::new(data_object),
        }
    }
}
