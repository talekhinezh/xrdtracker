...
/// SubstateIdentifier : Hex encoded unique identifier for the substate.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SubstateIdentifier {
    #[serde(rename = "identifier")]
    pub identifier: String,
}

impl SubstateIdentifier {
    /// Hex encoded unique identifier for the substate.
    pub fn new(identifier: String) -> SubstateIdentifier {
        SubstateIdentifier {
            identifier,
        }
    }
