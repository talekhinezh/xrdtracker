...
pub struct BelowMinimumStakeErrorAllOf {
    #[serde(rename = "minimum_stake")]
    pub minimum_stake: Box<crate::models::ResourceAmount>,
    #[serde(rename = "attempted_to_stake")]
    pub attempted_to_stake: Box<crate::models::ResourceAmount>,
}

impl BelowMinimumStakeErrorAllOf {
    pub fn new(minimum_stake: crate::models::ResourceAmount, attempted_to_stake: crate::models::ResourceAmount) -> BelowMinimumStakeErrorAllOf {
        BelowMinimumStakeErrorAllOf {
            minimum_stake: Box::new(minimum_stake),
            attempted_to_stake: Box::new(attempted_to_stake),
        }
    }
}
