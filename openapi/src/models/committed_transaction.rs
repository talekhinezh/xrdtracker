...
/// CommittedTransaction : A transaction which has been committed on ledger.
...
pub struct CommittedTransaction {
    ...
    #[serde(rename = "committed_state_identifier")]
    pub committed_state_identifier: Box<crate::models::StateIdentifier>,
    ...
    #[serde(rename = "operation_groups")]
    pub operation_groups: Vec<crate::models::OperationGroup>,
    #[serde(rename = "metadata")]
    pub metadata: Box<crate::models::CommittedTransactionMetadata>,
}

impl CommittedTransaction {
    /// A transaction which has been committed on ledger.
    pub fn new(transaction_identifier: crate::models::TransactionIdentifier, committed_state_identifier: crate::models::StateIdentifier, operation_groups: Vec<crate::models::OperationGroup>, metadata: crate::models::CommittedTransactionMetadata) -> CommittedTransaction {
        CommittedTransaction {
            transaction_identifier: Box::new(transaction_identifier),
            committed_state_identifier: Box::new(committed_state_identifier),
            operation_groups,
