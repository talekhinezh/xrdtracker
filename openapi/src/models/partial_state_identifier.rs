...
pub struct PartialStateIdentifier {
    #[serde(rename = "state_version")]
    pub state_version: i64,
    /// Accumulator hash representing all transactions which occurred up to `state_version`. Hex encoded.
    #[serde(rename = "transaction_accumulator", skip_serializing_if = "Option::is_none")]
    pub transaction_accumulator: Option<String>,
}

impl PartialStateIdentifier {
    pub fn new(state_version: i64) -> PartialStateIdentifier {
        PartialStateIdentifier {
            state_version,
            transaction_accumulator: None,
        }
    }
}
