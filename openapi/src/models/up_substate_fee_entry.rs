...
pub struct UpSubstateFeeEntry {
    #[serde(rename = "substate_type_identifier")]
    pub substate_type_identifier: Box<crate::models::SubstateTypeIdentifier>,
    #[serde(rename = "fee")]
    pub fee: Box<crate::models::ResourceAmount>,
}

impl UpSubstateFeeEntry {
    pub fn new(substate_type_identifier: crate::models::SubstateTypeIdentifier, fee: crate::models::ResourceAmount) -> UpSubstateFeeEntry {
        UpSubstateFeeEntry {
            substate_type_identifier: Box::new(substate_type_identifier),
            fee: Box::new(fee),
        }
    }
}
