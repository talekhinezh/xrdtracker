...
pub struct ResourceDepositOperationNotSupportedByEntityErrorAllOf {
    ...
    pub resource_deposit_not_supported: Box<crate::models::ResourceIdentifier>,
}

impl ResourceDepositOperationNotSupportedByEntityErrorAllOf {
    pub fn new(entity_identifier: crate::models::EntityIdentifier, resource_deposit_not_supported: crate::models::ResourceIdentifier) -> ResourceDepositOperationNotSupportedByEntityErrorAllOf {
        ResourceDepositOperationNotSupportedByEntityErrorAllOf {
            entity_identifier: Box::new(entity_identifier),
            resource_deposit_not_supported: Box::new(resource_deposit_not_supported),
        }
    }
}
