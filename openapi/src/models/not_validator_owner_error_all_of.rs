...
pub struct NotValidatorOwnerErrorAllOf {
    #[serde(rename = "owner")]
    pub owner: Box<crate::models::EntityIdentifier>,
    #[serde(rename = "user")]
    pub user: Box<crate::models::EntityIdentifier>,
}

impl NotValidatorOwnerErrorAllOf {
    pub fn new(owner: crate::models::EntityIdentifier, user: crate::models::EntityIdentifier) -> NotValidatorOwnerErrorAllOf {
