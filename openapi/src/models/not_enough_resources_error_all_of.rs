...
pub struct NotEnoughResourcesErrorAllOf {
    #[serde(rename = "fee")]
    pub fee: Box<crate::models::ResourceAmount>,
    #[serde(rename = "available")]
    pub available: Box<crate::models::ResourceAmount>,
    #[serde(rename = "attempted_to_take")]
    pub attempted_to_take: Box<crate::models::ResourceAmount>,
}

impl NotEnoughResourcesErrorAllOf {
    pub fn new(fee: crate::models::ResourceAmount, available: crate::models::ResourceAmount, attempted_to_take: crate::models::ResourceAmount) -> NotEnoughResourcesErrorAllOf {
        NotEnoughResourcesErrorAllOf {
            fee: Box::new(fee),
            available: Box::new(available),
            attempted_to_take: Box::new(attempted_to_take),
        }
    }
}
