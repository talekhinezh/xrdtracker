...
pub struct DataObjectNotSupportedByEntityError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl DataObjectNotSupportedByEntityError {
    pub fn new(_type: String, entity_identifier: crate::models::EntityIdentifier, data_object_not_supported: crate::models::DataObject) -> DataObjectNotSupportedByEntityError {
