...
pub struct SubstateDependencyNotFoundErrorAllOf {
    #[serde(rename = "substate_identifier_not_found")]
    pub substate_identifier_not_found: Box<crate::models::SubstateIdentifier>,
}

impl SubstateDependencyNotFoundErrorAllOf {
    pub fn new(substate_identifier_not_found: crate::models::SubstateIdentifier) -> SubstateDependencyNotFoundErrorAllOf {
        SubstateDependencyNotFoundErrorAllOf {
            substate_identifier_not_found: Box::new(substate_identifier_not_found),
        }
    }
}
