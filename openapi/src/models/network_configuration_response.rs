...
pub struct NetworkConfigurationResponse {
    ...
    pub version: Box<crate::models::NetworkConfigurationResponseVersion>,
    #[serde(rename = "network_identifier")]
    pub network_identifier: Box<crate::models::NetworkIdentifier>,
    #[serde(rename = "bech32_human_readable_parts")]
    pub bech32_human_readable_parts: Box<crate::models::Bech32Hrps>,
}

impl NetworkConfigurationResponse {
    pub fn new(version: crate::models::NetworkConfigurationResponseVersion, network_identifier: crate::models::NetworkIdentifier, bech32_human_readable_parts: crate::models::Bech32Hrps) -> NetworkConfigurationResponse {
        NetworkConfigurationResponse {
            version: Box::new(version),
            network_identifier: Box::new(network_identifier),
            bech32_human_readable_parts: Box::new(bech32_human_readable_parts),
        }
    }
}
