...
pub struct ValidatorAllowDelegationAllOf {
...
impl ValidatorAllowDelegationAllOf {
    pub fn new(allow_delegation: bool) -> ValidatorAllowDelegationAllOf {
        ValidatorAllowDelegationAllOf {
            allow_delegation,
        }
    }
}
