...
pub struct PreparedValidatorOwnerAllOf {
    #[serde(rename = "owner")]
...
impl PreparedValidatorOwnerAllOf {
    pub fn new(owner: crate::models::EntityIdentifier) -> PreparedValidatorOwnerAllOf {
        PreparedValidatorOwnerAllOf {
            owner: Box::new(owner),
            epoch: None,
        }
    }
