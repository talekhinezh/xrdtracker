...
pub struct VirtualParentDataAllOf {
    #[serde(rename = "entity_set_identifier")]
    pub entity_set_identifier: Box<crate::models::EntitySetIdentifier>,
    #[serde(rename = "virtual_data_object")]
    pub virtual_data_object: Box<crate::models::DataObject>,
}

impl VirtualParentDataAllOf {
    pub fn new(entity_set_identifier: crate::models::EntitySetIdentifier, virtual_data_object: crate::models::DataObject) -> VirtualParentDataAllOf {
        VirtualParentDataAllOf {
            entity_set_identifier: Box::new(entity_set_identifier),
            virtual_data_object: Box::new(virtual_data_object),
        }
    }
}
