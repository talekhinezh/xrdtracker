...
/// CommittedTransactionsResponse : A response of committed transactions which specifies the state updates which have occurred on ledger.
...
pub struct CommittedTransactionsResponse {
    ...
    pub state_identifier: Box<crate::models::StateIdentifier>,
    /// A committed transactions list starting from the `state_identifier`.
    #[serde(rename = "transactions")]
    pub transactions: Vec<crate::models::CommittedTransaction>,
}
...
impl CommittedTransactionsResponse {
    ...
    pub fn new(state_identifier: crate::models::StateIdentifier, transactions: Vec<crate::models::CommittedTransaction>) -> CommittedTransactionsResponse {
        CommittedTransactionsResponse {
            state_identifier: Box::new(state_identifier),
            transactions,
        }
    }
}
