...
pub struct ConstructionDeriveRequestMetadataPreparedStakesAllOf {
    #[serde(rename = "validator")]
    pub validator: Box<crate::models::EntityIdentifier>,
}

impl ConstructionDeriveRequestMetadataPreparedStakesAllOf {
    pub fn new(validator: crate::models::EntityIdentifier) -> ConstructionDeriveRequestMetadataPreparedStakesAllOf {
