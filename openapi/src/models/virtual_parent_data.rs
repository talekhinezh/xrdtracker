...
impl VirtualParentData {
    pub fn new(_type: String, entity_set_identifier: crate::models::EntitySetIdentifier, virtual_data_object: crate::models::DataObject) -> VirtualParentData {
        VirtualParentData {
            _type,
