...
pub struct EngineConfiguration {
    ...
    pub native_token: Box<crate::models::TokenResourceIdentifier>,
    #[serde(rename = "maximum_message_length")]
    pub maximum_message_length: i32,
    #[serde(rename = "maximum_validators")]
    pub maximum_validators: i32,
    #[serde(rename = "token_symbol_pattern")]
    pub token_symbol_pattern: String,
    #[serde(rename = "unstaking_delay_epoch_length")]
    pub unstaking_delay_epoch_length: i64,
    #[serde(rename = "minimum_completed_proposals_percentage")]
    pub minimum_completed_proposals_percentage: i32,
    #[serde(rename = "maximum_transaction_size")]
    pub maximum_transaction_size: i64,
    #[serde(rename = "maximum_transactions_per_round")]
    pub maximum_transactions_per_round: i32,
    #[serde(rename = "validator_fee_increase_debouncer_epoch_length")]
    pub validator_fee_increase_debouncer_epoch_length: i64,
    #[serde(rename = "maximum_rounds_per_epoch")]
    pub maximum_rounds_per_epoch: i64,
    #[serde(rename = "maximum_validator_fee_increase")]
    pub maximum_validator_fee_increase: i32,
    #[serde(rename = "minimum_stake")]
    pub minimum_stake: Box<crate::models::ResourceAmount>,
    #[serde(rename = "rewards_per_proposal")]
    pub rewards_per_proposal: Box<crate::models::ResourceAmount>,
    #[serde(rename = "reserved_symbols")]
    pub reserved_symbols: Vec<String>,
    #[serde(rename = "fee_table")]
    pub fee_table: Box<crate::models::FeeTable>,
}

impl EngineConfiguration {
    pub fn new(native_token: crate::models::TokenResourceIdentifier, maximum_message_length: i32, maximum_validators: i32, token_symbol_pattern: String, unstaking_delay_epoch_length: i64, minimum_completed_proposals_percentage: i32, maximum_transaction_size: i64, maximum_transactions_per_round: i32, validator_fee_increase_debouncer_epoch_length: i64, maximum_rounds_per_epoch: i64, maximum_validator_fee_increase: i32, minimum_stake: crate::models::ResourceAmount, rewards_per_proposal: crate::models::ResourceAmount, reserved_symbols: Vec<String>, fee_table: crate::models::FeeTable) -> EngineConfiguration {
        EngineConfiguration {
            ...
            minimum_stake: Box::new(minimum_stake),
            rewards_per_proposal: Box::new(rewards_per_proposal),
            reserved_symbols,
            fee_table: Box::new(fee_table),
        }
    }
}
