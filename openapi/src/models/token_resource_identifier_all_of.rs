...
pub struct TokenResourceIdentifierAllOf {
    /// The Radix Resource Identifier \"RRI\" of the token.
    #[serde(rename = "rri")]
    pub rri: String,
}

impl TokenResourceIdentifierAllOf {
    pub fn new(rri: String) -> TokenResourceIdentifierAllOf {
        TokenResourceIdentifierAllOf {
            rri,
        }
    }
}
