...
pub struct BelowMinimumStakeError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl BelowMinimumStakeError {
    pub fn new(_type: String, minimum_stake: crate::models::ResourceAmount, attempted_to_stake: crate::models::ResourceAmount) -> BelowMinimumStakeError {
