...
pub struct InvalidSignatureErrorAllOf {
    #[serde(rename = "invalid_signature")]
    pub invalid_signature: String,
}

impl InvalidSignatureErrorAllOf {
    pub fn new(invalid_signature: String) -> InvalidSignatureErrorAllOf {
