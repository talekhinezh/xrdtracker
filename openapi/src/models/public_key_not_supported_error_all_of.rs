...
pub struct PublicKeyNotSupportedErrorAllOf {
    #[serde(rename = "unsupported_public_key")]
    pub unsupported_public_key: Box<crate::models::PublicKey>,
}

impl PublicKeyNotSupportedErrorAllOf {
    pub fn new(unsupported_public_key: crate::models::PublicKey) -> PublicKeyNotSupportedErrorAllOf {
        PublicKeyNotSupportedErrorAllOf {
            unsupported_public_key: Box::new(unsupported_public_key),
        }
    }
}
