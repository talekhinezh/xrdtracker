...
pub struct ConstructionDeriveRequestMetadataAccount {
    #[serde(rename = "type")]
    pub _type: String,
}

impl ConstructionDeriveRequestMetadataAccount {
    pub fn new(_type: String) -> ConstructionDeriveRequestMetadataAccount {
