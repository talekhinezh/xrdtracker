...
pub struct ResourceWithdrawOperationNotSupportedByEntityError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl ResourceWithdrawOperationNotSupportedByEntityError {
    pub fn new(_type: String, entity_identifier: crate::models::EntityIdentifier, resource_withdraw_not_supported: crate::models::ResourceIdentifier) -> ResourceWithdrawOperationNotSupportedByEntityError {
