...
impl Transaction {
    pub fn new(transaction_identifier: crate::models::TransactionIdentifier, operation_groups: Vec<crate::models::OperationGroup>, metadata: crate::models::CommittedTransactionMetadata) -> Transaction {
        Transaction {
