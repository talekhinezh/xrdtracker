...
pub struct PreparedValidatorRegisteredAllOf {
...
impl PreparedValidatorRegisteredAllOf {
    pub fn new(registered: bool) -> PreparedValidatorRegisteredAllOf {
        PreparedValidatorRegisteredAllOf {
            registered,
            epoch: None,
        }
    }
