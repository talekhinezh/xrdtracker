...
pub struct AboveMaximumValidatorFeeIncreaseErrorAllOf {
    ...
    pub attempted_validator_fee_increase: i32,
}

impl AboveMaximumValidatorFeeIncreaseErrorAllOf {
    pub fn new(maximum_validator_fee_increase: i32, attempted_validator_fee_increase: i32) -> AboveMaximumValidatorFeeIncreaseErrorAllOf {
        AboveMaximumValidatorFeeIncreaseErrorAllOf {
