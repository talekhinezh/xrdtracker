...
pub struct InvalidFeePayerEntityErrorAllOf {
    #[serde(rename = "invalid_fee_payer_entity")]
    pub invalid_fee_payer_entity: Box<crate::models::EntityIdentifier>,
}

impl InvalidFeePayerEntityErrorAllOf {
    pub fn new(invalid_fee_payer_entity: crate::models::EntityIdentifier) -> InvalidFeePayerEntityErrorAllOf {
        InvalidFeePayerEntityErrorAllOf {
            invalid_fee_payer_entity: Box::new(invalid_fee_payer_entity),
        }
    }
}
