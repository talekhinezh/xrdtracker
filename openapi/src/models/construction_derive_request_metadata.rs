...
#[serde(tag = "type")]
pub enum ConstructionDeriveRequestMetadata {
    #[serde(rename="Account")]
    ConstructionDeriveRequestMetadataAccount {
    },
    #[serde(rename="ExitingUnstakes")]
    ConstructionDeriveRequestMetadataExitingUnstakes {
        #[serde(rename = "validator")]
        validator: Box<crate::models::EntityIdentifier>,
        #[serde(rename = "epoch_unlock")]
        epoch_unlock: i64,
    },
    #[serde(rename="PreparedStakes")]
    ConstructionDeriveRequestMetadataPreparedStakes {
        #[serde(rename = "validator")]
        validator: Box<crate::models::EntityIdentifier>,
    },
    #[serde(rename="PreparedUnstakes")]
