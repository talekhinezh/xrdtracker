...
pub struct ConstructionBuildResponse {
    /// Hex encoded unsigned transaction.
    #[serde(rename = "unsigned_transaction")]
    pub unsigned_transaction: String,
    /// Hex encoded hash payload to sign.
    #[serde(rename = "payload_to_sign")]
    pub payload_to_sign: String,
}

impl ConstructionBuildResponse {
    pub fn new(unsigned_transaction: String, payload_to_sign: String) -> ConstructionBuildResponse {
