...
pub struct ValidatorSystemMetadataAllOf {
    /// A hex encoded byte array.
    #[serde(rename = "data")]
    pub data: String,
}

impl ValidatorSystemMetadataAllOf {
    pub fn new(data: String) -> ValidatorSystemMetadataAllOf {
        ValidatorSystemMetadataAllOf {
            data,
        }
    }
}
