...
pub struct StateIdentifierNotFoundErrorAllOf {
    #[serde(rename = "state_identifier")]
    pub state_identifier: Box<crate::models::PartialStateIdentifier>,
}

impl StateIdentifierNotFoundErrorAllOf {
    pub fn new(state_identifier: crate::models::PartialStateIdentifier) -> StateIdentifierNotFoundErrorAllOf {
