...
pub struct Substate {
    ...
    #[serde(rename = "substate_operation")]
    pub substate_operation: SubstateOperation,
    #[serde(rename = "substate_identifier")]
    pub substate_identifier: Box<crate::models::SubstateIdentifier>,
}

impl Substate {
    pub fn new(substate_operation: SubstateOperation, substate_identifier: crate::models::SubstateIdentifier) -> Substate {
        Substate {
            substate_operation,
            substate_identifier: Box::new(substate_identifier),
        }
    }
}
...
impl Default for SubstateOperation {
    fn default() -> SubstateOperation {
        Self::BOOTUP
    }
}
