...
pub struct ConstructionFinalizeRequest {
    ...
    pub signature: Box<crate::models::Signature>,
}

impl ConstructionFinalizeRequest {
    pub fn new(network_identifier: crate::models::NetworkIdentifier, unsigned_transaction: String, signature: crate::models::Signature) -> ConstructionFinalizeRequest {
