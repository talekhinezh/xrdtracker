...
pub struct NotEnoughResourcesError {
    #[serde(rename = "type")]
    pub _type: String,
    #[serde(rename = "fee")]
...
impl NotEnoughResourcesError {
    pub fn new(_type: String, fee: crate::models::ResourceAmount, available: crate::models::ResourceAmount, attempted_to_take: crate::models::ResourceAmount) -> NotEnoughResourcesError {
