...
pub struct InvalidPublicKeyErrorAllOf {
    #[serde(rename = "invalid_public_key")]
    pub invalid_public_key: Box<crate::models::PublicKey>,
}

impl InvalidPublicKeyErrorAllOf {
    pub fn new(invalid_public_key: crate::models::PublicKey) -> InvalidPublicKeyErrorAllOf {
        InvalidPublicKeyErrorAllOf {
            invalid_public_key: Box::new(invalid_public_key),
        }
    }
}
