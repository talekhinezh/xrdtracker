...
pub struct InvalidSubEntityErrorAllOf {
    #[serde(rename = "invalid_sub_entity")]
    pub invalid_sub_entity: Box<crate::models::SubEntity>,
}

impl InvalidSubEntityErrorAllOf {
    pub fn new(invalid_sub_entity: crate::models::SubEntity) -> InvalidSubEntityErrorAllOf {
        InvalidSubEntityErrorAllOf {
            invalid_sub_entity: Box::new(invalid_sub_entity),
        }
    }
}
