...
pub struct ConstructionDeriveRequestMetadataExitingUnstakesAllOf {
    #[serde(rename = "validator")]
    pub validator: Box<crate::models::EntityIdentifier>,
    #[serde(rename = "epoch_unlock")]
    pub epoch_unlock: i64,
}

impl ConstructionDeriveRequestMetadataExitingUnstakesAllOf {
    pub fn new(validator: crate::models::EntityIdentifier, epoch_unlock: i64) -> ConstructionDeriveRequestMetadataExitingUnstakesAllOf {
        ConstructionDeriveRequestMetadataExitingUnstakesAllOf {
