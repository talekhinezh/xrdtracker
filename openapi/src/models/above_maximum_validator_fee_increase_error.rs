...
pub struct AboveMaximumValidatorFeeIncreaseError {
    #[serde(rename = "type")]
    pub _type: String,
...
impl AboveMaximumValidatorFeeIncreaseError {
    pub fn new(_type: String, maximum_validator_fee_increase: i32, attempted_validator_fee_increase: i32) -> AboveMaximumValidatorFeeIncreaseError {
