...
pub struct Operation {
    ...
    pub substate: Option<Box<crate::models::Substate>>,
    #[serde(rename = "amount", skip_serializing_if = "Option::is_none")]
    pub amount: Option<Box<crate::models::ResourceAmount>>,
...
impl Operation {
    pub fn new(_type: String, entity_identifier: crate::models::EntityIdentifier) -> Operation {
        Operation {
            _type,
