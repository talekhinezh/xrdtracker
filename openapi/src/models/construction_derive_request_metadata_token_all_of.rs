...
pub struct ConstructionDeriveRequestMetadataTokenAllOf {
    /// The symbol of the token
    #[serde(rename = "symbol")]
    pub symbol: String,
}

impl ConstructionDeriveRequestMetadataTokenAllOf {
    pub fn new(symbol: String) -> ConstructionDeriveRequestMetadataTokenAllOf {
